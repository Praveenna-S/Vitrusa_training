...
public class SerializationExample {
    ...
    {
        Employee empObj = new Employee("Sharmi", "Prasad", "Sharma", 25, "IT");
    ...
    static Employee deserialize() throws IOException, ClassNotFoundException
    {
        ...
        {
           // System.out.println("Object at serialization  => " + ois.readObject());
    ...
    {
        // This serialVersionUID field is necessary for Serializable to provide version control,
